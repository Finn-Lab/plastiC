...
def plastid_bin_stats(binpath, plastidseqlist):
    ...
    binfasta = [item for item in filelist if ".fai" not in item]
...
if __name__ == "__main__":
    ...
    ap.add_argument('-b', '--binsize', required=True, type = int, help = "Threshold of plastid bin content", default = 90)
    args = ap.parse_args()
    ...
    filteredplastids = list(plastidbin_dataframe[plastidbin_dataframe["plastid_nt_percent"] >= args.binsize]["binid"])
